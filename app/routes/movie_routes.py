...
from app.services.movies_service import get_movies_from_db, count_movies_in_db, get_movie_details_from_db, search_movies
...
@movie_bp.route("/search_movie", methods=["GET"])
def search_movie():
